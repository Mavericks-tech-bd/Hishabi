...
import type { DashboardSummary } from "@/components/HishabiDashboard";
    ...
    <>
      <section className="mb-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Seller ID is synced from Global Seller ID. You can still change it manually here.
        </p>
        ...
        <section className="space-y-6">
          <section className="grid gap-4 md:grid-cols-4">
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              ...
              <h2 className="mt-2 text-3xl font-bold">{dashboardSummary.total_products}</h2>
            </div>
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <p className="text-sm text-slate-500">Total Customers</p>
              <h2 className="mt-2 text-3xl font-bold">{dashboardSummary.total_customers}</h2>
            </div>
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <p className="text-sm text-slate-500">Total Orders</p>
              <h2 className="mt-2 text-3xl font-bold">{dashboardSummary.total_orders}</h2>
            </div>
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <p className="text-sm text-slate-500">Total Sales</p>
              <h2 className="mt-2 text-3xl font-bold">{formatTaka(dashboardSummary.total_sales)}</h2>
            </div>
          </section>
          <section className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-white p-5 shadow-sm">
              <p className="text-sm text-slate-500">Average Order Value</p>
              <h2 className="mt-2 text-3xl font-bold">{formatTaka(dashboardSummary.average_order_value)}</h2>
            </div>
            <div className="rounded-2xl bg-yellow-50 p-5 shadow-sm ring-1 ring-yellow-100">
              ...
              <h2 className="mt-2 text-3xl font-bold text-yellow-800">{dashboardSummary.pending_orders}</h2>
            </div>
            <div className="rounded-2xl bg-blue-50 p-5 shadow-sm ring-1 ring-blue-100">
              ...
              <h2 className="mt-2 text-3xl font-bold text-blue-800">{dashboardSummary.confirmed_orders}</h2>
            </div>
            <div className="rounded-2xl bg-purple-50 p-5 shadow-sm ring-1 ring-purple-100">
              ...
              <h2 className="mt-2 text-3xl font-bold text-purple-800">{dashboardSummary.shipped_orders}</h2>
            </div>
            <div className="rounded-2xl bg-green-50 p-5 shadow-sm ring-1 ring-green-100">
              ...
              <h2 className="mt-2 text-3xl font-bold text-green-800">{dashboardSummary.delivered_orders}</h2>
            </div>
            <div className="rounded-2xl bg-red-50 p-5 shadow-sm ring-1 ring-red-100">
              <p className="text-sm text-red-700">Cancelled Orders</p>
              <h2 className="mt-2 text-3xl font-bold text-red-800">{dashboardSummary.cancelled_orders}</h2>
            </div>
          </section>
        </section>
      )}
